...
/// <summary>
/// Mantem o AuthenticationState em sincronia com a BD (chama SecurityStamp check periodicamente).
/// </summary>
    ...
    where TUser : class
{
    ...
    private async Task<bool> ValidateSecurityStampAsync(UserManager<TUser> userManager, System.Security.Claims.ClaimsPrincipal principal)
    {
        ...
        var stamp = principal.FindFirst(_options.ClaimsIdentity.SecurityStampClaimType)?.Value;
