    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-6">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <Link href="/socio/dados" className="rounded border border-slate-300 px-4 py-2 text-sm hover:bg-slate-50">
            Atualizar dados
          </Link>
...
function Card({
  ...
  const toneCls = tone === "ok" ? "text-green-700" : tone === "warn" ? "text-amber-700" : "text-slate-900";
  const body = (
    <>
  ...
  const cls = "block rounded-lg border border-slate-200 bg-white p-4 shadow-sm hover:shadow";
