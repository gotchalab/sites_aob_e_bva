      ...
      <aside className="md:sticky md:top-8 md:h-fit">
        <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <nav className="mt-4 flex flex-col gap-1 text-sm">
            <Link href="/socio" className="rounded px-2 py-1 hover:bg-slate-100">Dashboard</Link>
            <Link href="/socio/dados" className="rounded px-2 py-1 hover:bg-slate-100">Os meus dados</Link>
            <Link href="/socio/quotas" className="rounded px-2 py-1 hover:bg-slate-100">Quotas</Link>
            <Link href="/socio/anilhas" className="rounded px-2 py-1 hover:bg-slate-100">Anilhas</Link>
            <Link href="/socio/pedir-anilhas" className="rounded px-2 py-1 hover:bg-slate-100">Novo pedido</Link>
          </nav>
          <LogoutButton />
        </div>
      </aside>
