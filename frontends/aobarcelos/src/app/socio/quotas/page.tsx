...
export default async function QuotasPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-slate-500">Histórico de pagamentos de quotas anuais.</p>

      {quotas.length === 0 ? (
        <p className="mt-6 text-slate-500">Sem registos.</p>
      ) : (
        <table className="mt-6 w-full rounded border border-slate-200 bg-white text-sm">
