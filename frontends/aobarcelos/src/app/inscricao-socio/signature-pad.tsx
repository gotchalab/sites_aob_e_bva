...
export function SignaturePad({
  ...
  // Recorta o canvas para a bounding box dos pixels desenhados (mais 4pt de margem).
  // Garante que o PDF recebe apenas a assinatura com proporcao natural.
  ...
  return (
    <div>
      <div
        ref={wrapperRef}
        className="relative overflow-hidden rounded-lg border border-slate-300 bg-white shadow-inner"
      ...
      <div className="mt-2 flex justify-between text-xs">
        <span className="text-slate-500">Desenhe a sua assinatura no espaço acima</span>
        <button
          type="button"
          onClick={clear}
