    ...
    <>
      <section className="hero-pattern border-b border-gold-500/30">
        <div className="mx-auto max-w-5xl px-4 py-12 md:py-16">
          ...
          <h1 className="font-display text-4xl font-bold leading-tight text-earth-900 md:text-5xl">
            Contacto
          </h1>
          <p className="mt-4 max-w-2xl text-lg leading-relaxed text-earth-700">
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 md:py-16">
        <div className="grid gap-8 md:grid-cols-[1fr_2fr]">
          <aside className="space-y-6">
            {site.contactEmail && (
              <div className="rounded-2xl border border-gold-500/30 bg-white/70 p-6 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a
                      className="font-medium text-earth-900 hover:text-brand-600"
            ...
            <div className="rounded-2xl border border-earth-800/10 bg-earth-900 p-6 text-white shadow-sm">
              <div className="flex items-center gap-3">
              ...
              <dl className="mt-4 space-y-2 text-sm">
                <div className="flex items-baseline justify-between gap-4 border-b border-white/10 pb-2">
                  <dt className="text-white/70">Sextas-feiras</dt>
                  <dd className="font-medium text-white">21h — 24h</dd>
                </div>
                <div className="flex items-baseline justify-between gap-4">
                  <dt className="text-white/70">Agosto</dt>
                  <dd className="font-medium text-brand-400">Encerrado (férias)</dd>
                </div>
              </dl>
          ...
          <div className="rounded-2xl border border-gold-500/30 bg-white p-6 shadow-lg md:p-8">
            <ContactForm />
          </div>
        </div>
      </div>
