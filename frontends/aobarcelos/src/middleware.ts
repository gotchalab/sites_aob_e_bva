...
const COOKIE_ACCESS = "aob_socio_at";
const COOKIE_REFRESH = "aob_socio_rt";
const COOKIE_USER_ID = "aob_socio_uid";
...
function unauthorized(req: NextRequest, path: string, isApi: boolean) {
  ...
  // internal host, so absolute redirects would leak "localhost:3000" to browsers.
