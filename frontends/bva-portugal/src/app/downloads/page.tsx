      ...
      <div className="mx-auto max-w-6xl px-4 py-10 md:py-14">
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <section className="min-w-0 flex-1">
            {list.items.length === 0 ? (
              <p className="text-ink-500">Sem downloads.</p>
            ) : (
              <ul className="rounded-2xl border border-sand-300 bg-white px-4 shadow-sm">
                {list.items.map((d) => (
                  ...
                  return (
                    <Link
                      ...
                      className={`rounded-md px-3 py-1.5 text-sm transition ${
                        p === page
                          ? "bg-brand-500 text-white"
                          : "border border-sand-300 text-ink-700 hover:bg-sand-100 hover:text-brand-600"
                      }`}
                    >
                      {p}
                    </Link>
