...
export async function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-sand-300/70 bg-white/85 backdrop-blur supports-[backdrop-filter]:bg-white/70">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 md:h-20 md:gap-6">
        ...
        <div className="hidden shrink-0 items-center gap-1 lg:flex">
          <Link
            ...
            title="Contactar"
            className="flex h-10 w-10 items-center justify-center rounded-full text-ink-700 transition hover:bg-sand-200 hover:text-brand-600"
          >
